...
<head>
  ...
  <!--[if IE]>
      ...
      <![endif]-->
  <title>Social Outreach | Jain International School</title>
  <link rel="icon" type="image/png" href="/media/beyond_academics/social_outreach/favicon.png">
  <!-- Mobile Specific Metas ================================-->
  <meta http-equiv="X-UA-Compatible" content="IE=edge">
  <meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no">
  <meta name="author" content="Flying Penguins">
  <meta name="description"
    content="At Jain International school we encourages students to actively take part in our societal outreach program in order to cultivate their sense of empathy, responsibility, concern for the underprivileged, environmental awareness and gratitude.">
  ...
  <link rel="stylesheet" type="text/css" href="src/extra/css/beyond-academics.css">
  <style type="text/css">
    .club-list li {
...
<body class="header-sticky">
  ...
  <div class="header_Name"
    ...
    <div class="col-md-2 col-sm-12 col-xs-6 hide-on-mob-tab" style="width: 9.666667%;"><a href="/index" rel="home"><img
          alt="image" class="logo-height" src="/media/logos/logo.png" style="margin-top: 6px;" /> </a></div>

    <div>
      <h1 class="header_Name_title"
        style=" margin-bottom:2%;margin-top:2%;color:#f8c300 ; font-family:FreesiaUPC; font-size: 60px;">THE JAIN
        INTERNATIONAL SCHOOL</h1>
    </div>

    <div style="    margin-left: 50px;margin-top: 20px;"><a class="hide-on-mob-tab" href="/index" rel="home"><img
          alt="image" class="logo-height trustee_logo" src="/media/logos/trustee_logo.png" /> </a></div>
  </div>
...
<!--<div class="tl-topbar bg-dark" id="tl-topbar">-->
  ...
  <div id="banner-area" class="banner-area"
    style="background-image: url(/media/beyond_academics/social_outreach/Societal_Outreach_Banner.jpg)" data-hover-only="true">
  </div>
  <div class="holistic-row">
    <div class="auto-container">
      <div class="text-center">
        <h2><span class="text-sky">Community </span>Service</h2>
        <p>The school encourages students to actively take part in our societal outreach program in order to cultivate
          their sense of empathy, responsibility, concern for the underprivileged, environmental awareness and
          gratitude. Through these programs, we aim to mould our children into global responsible citizens. They develop
          a greater sense of inclusion with the community and commitment. </p>
        <!--  <div class="row" style="padding-top: 3%;">
             <div class="col-md-2"></div>
             <div class="col-md-4">
             <ul class="club-list" style="text-align: left;">
               <li>Art & Craft Club</li>
               <li>Classical Dance Club</li>
               <li>Coding Club</li>
               <li>Cookery Club</li>
               <li>Debate Club</li>
               <li>Heritage Club</li>
               <li>Literary knowledge Club (English)</li>
               <li>Maths Club</li>
             ...
             <ul class="club-list" style="text-align: left;">
               <li>Science Club</li>
               <li>Music Club<ul style="padding-left: 18px;">
                  <li>Western Music(Instrumental-Drums, Octapad)</li>
                  <li>Western Music(Instrumental-Guitar)</li>
                  <li>Western Vocals</li>
                  <li>Indian Instrumental</li>
                  <li>Indian Vocal</li>
                </ul></li>

               <li>Quiz Club</li>
               <li>DIY Ninja Club</li>
             </ul>
             </div>
             <div class="col-md-2"></div>
             </div> -->
 ...
 <div class="container" style="display: flex; padding:5%; margin-top:2%">
      
        
         
      
            <img src="/media/beyond_academics/social_outreach/IMG-20231010-WA0043.jpg" alt="Sorry!!!" style="margin-top:2%; width:40%; height:30%">
    ...
    <div class="row row-margin">
      ...
      <div class="col-lg-6 annual-column" style="margin-left:10%; width:100%">
        <div class="box-annual">
          <h5 class="social-heading"></h5>
          <p class="paragraph">
          <b> Ek Mutthi Barkat Ki </b>is an initiative taken by the school to donate grains to orphange homes, old age homes every month. The school encourages students to actively take part in the social outreach program innorder to cultivate their sense of empathy,  responsibility, concern for the underprivileged, environmental awareness and gratitude.  Through these programs, we aim to mould our children into global responsible citizens. They develop a greater sense of inclusion with the community and commitment.
      ...
      <div class="caption-box clearfix" >
                <div class="icon-box">
                  <a href="https://drive.google.com/uc?export=view&id=13A9B2rhi6h_yhmg-GtCT70BMOWFZDXmI" class="link" data-fancybox="gallery"
  ...
  <div class="row" id="banner-area" class="banner-area" data-hover-only="true">
    <div class="col-lg-6">
      <div class="row-background">
        <!-- <h2 class="outreach-heading" style="margin-top: 70px;"></h2> -->
        <div class="box-annual">
        <p class="paragraph">Students actively contribute to social causes like donations for natural disasters, war
          widows and families, farmers of Vidarbha etc. They also participate passionately in donating books, shoes,
          stationery, warm clothes, toiletries and staples to the needy. They visit old age homes spending quality time
          with the inmates. Our students also regularly visit orphanages and schools for the differently-abled thus
          developing gratitude for what they are blessed with.</p>
          </div>
      </div>
    </div>
    <div class="col-lg-6" style="padding: 0 !important; margin-top:2%;">
      <img src="/media/beyond_academics/social_outreach/Societal_Outreach_Top_Right.jpg" width="100%">
    </div>
  </div>
...
<br><br>
  ...
  <div class="row" id="banner-area" class="banner-area" data-hover-only="true">
    <div class="col-lg-6" style="padding: 0 !important;">
      <img src="/media/beyond_academics/social_outreach/Societal-Outreach-Bottom-Left.jpg" width="100%" style=" margin-left:20%;">
    </div>
    <div class="col-lg-6">
      <div class="row-background">
        <!-- <h2 class="outreach-heading" style="margin-top: 70px;">Values and Life Skills woven into every lesson !</h2> -->

        <p class="paragraph">
          Students are sensitized to current environmental issues through conservation projects like tree plantation
          drives. One of the prominent activities that the Interact Club of the school dutifully conducts is
          eco-friendly Ganesh Visarjan during Ganesh festival each year making devotees aware of water pollution and
          collecting Nirmalya for safe disposal. Our students participate in skill development; teaching commercially
          viable art and craft to rural children and women. They conduct Nukkad Naataks on socially relevant issues like
          removing gender bias or girl child education. Through these activities, our children learn to empathize with
          the deprived and develop a greater sense of commitment towards society.
        </p>
      </div>
    </div>
  </div>
