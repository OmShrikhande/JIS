...
<head>
  ...
  <!--[if IE]>
      ...
      <![endif]-->
  <title>
    Sports | The Jain International School</title>
  <link rel="icon" type="image/png" href="/media/beyond_academics/sports/favicon.png">
  ...
  <meta name="description"
    content="At The Jain International School, an hour a day is dedicated for games & sports for all students. Our expert coaches teach them the nuances of every sport and focus on team-building along with individual development.">
...
<body class="header-sticky">
 ...
 <!--===================Header===========-->
      ...
      <div class="sports-vid">
        <br><br><br>
        <video autoplay muted loop id="myVideo" style="align-items:center; width:40%; height:30%; " controls>
          <source src="https://drive.google.com/uc?export=view&id=15NN-s0x8vprV-K0y2OtERzQKa-DPwvh8" type="video/mp4">
        </video>
        <!--<img src="/images/beyond-aca/obstacle_course.jpg" alt="sports-image">-->
      </div>
   
        <div class="col-lg-6">
          <h5 class="social-heading" style="text-align:center;">Enhancing Fitness</h5>
          <p class="paragraph">At The Jain International School, an hour a day is dedicated for games & sports for all
            students. We believe that for a healthy mind that is conducive to learning, a healthy body is of utmost
            importance. This is why we focus continually on physical exercise and following a healthy lifestyle. The
            school provides training for many games and sports including Lawn Tennis, Swimming, Basketball, Volleyball,
            Cricket, Skating, Football, Yoga, Table Tennis, Chess, Karate, Aerobics, Zumba, Kabaddi under the guidance
            of expert coaches. Sports are an indispensable part of a school's curriculum. Our expert coaches teach them
            the nuances of every sport and focus on team-building along with individual development. Students can choose
            to specialize in any of the sports and take it up more seriously in future. </p><p>Sports we believe is equally important for social and emotional well-being. It helps
            students to develop life skills such as handling success and failure, decision-making, working in a team,
            attentiveness and healthy appreciation of fellow members.</p>
        </div>
<br><br><br>
  ...
  <!-- <div class="container">
        <div class="row row-margin">
          <div class="col-lg-8 column-background">
            <div class="box">
            <h5 class="social-heading">Beyond academics</h5>
            <p class="paragraph">Sports are an indispensable part of a school’s curriculum. At TJIS, we ensure that students compulsorily participate in sports and find their forte or niche. Our curriculum allows students to rotate between different kinds of sports each year so that they can experience all of them and decide what they would like to pursue. Our expert coaches teach them the nuances of every sport and focus on team-building along with individual development. Students can also choose to specialize in any of the sports and take it up more seriously. </p>
            </div>
          </div>
          <div class="col-lg-4">
            <img src="/images/beyond-aca/beyond-academics.jpg" alt="sports-image" style="float: right;">
          </div>
        </div>
        </div> -->

  <div class="container">
    <div class="row row-margin row-margin-bottom">
      <div class="col-lg-4">
        
      </div>
      <div class="col-lg-8 column-background">
        <div class="box">
          <h5 class="social-heading"><!-- one v more--></h5>
          <p class="paragraph"></p>
        </div>
      </div>
    </div>
