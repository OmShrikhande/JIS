...
<head>
  ...
  <!--[if IE]>
      ...
      <![endif]-->
  <title>Academics | Senior Secondary School | The Jain International School
  </title>
  <link rel="icon" type="image/png" href="/media/academics/senior_secondary/favicon.png">
  <!-- Mobile Specific Metas ================================-->
  <meta http-equiv="X-UA-Compatible" content="IE=edge">
  <meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no">
  <meta name="author" content="Flying Penguins">
  <meta name="description"
    content="JIS Senior Seconday, is where the students are offered with Science and Commerce Streams at the Senior Secondary Level. An experienced faculty ensures that every student's potential is tapped and latent talents are brought to the fore.">
...
<body class="header-sticky">
 ...
 <? include'./header.php' ?>
  ...
  <!--end sticky panel-->
  <div id="banner-area" class="banner-area" style="background-image: url(/media/academics/senior_secondary/senior_sec_banner_11.jpg)"
    ...
    <div class="container">
      <div class="row">
        <div class="col-md-10 col-md-offset-1">
          <p class="primary-para">The Jain International School offers Science and Commerce Streams at the Senior
            Secondary Level.
          </p>
          <br>
          <p class="primary-para">The Senior Secondary section, comprising Science and Commerce streams, fulfills JIS'
            promise of providing education beyond the classroom. The burgeoning strength of the section can be
            attributed to its focus on giving students an exposure to the outside world. Visits to the NSE (National
            Stock Exchange) and industries, workshops on Tally and residential adventure camps all form part of the
            holistic education package that bears the quintessential stamp of JIS. The section's academic performance
            has always been spectacular. An experienced faculty ensures that every student's potential is tapped and
            latent talents are brought to the fore.</p>
        </div>
      </div>
    </div>
  </section>
  <section class="t-seven-module grid-module">
    <div class="holder clearfix">
      <article data-speed="-0.0">
        <h3>Facilitating better learning</h3>
        <h4>Augmenting in-class learning with practicals</h4>
        <p class="primary-para">The school has laboratories well stocked with instruments and equipments required to
          assist all kinds of practicals prescribed by CBSE. Well-trained, and proficient staff who are committed to
          nurturing every child’s interests form the backbone of the Senior Secondary Section. The school also aids
          children in taking professional exams like IIT-JEE, NEET, CLAT, CA/CS CPT etc.
        </p>
      </article>
      <span class="layer-one parallax" data-speed="-0.02"></span>
      <div class="bgr-holder parallax" data-speed="0.0"
        style="background-image:url(/media/academics/senior_secondary/Facilitating-better-learning_1.jpg); width: auto;">

      </div>
    </div>
    <img src="/media/academics/senior_secondary/Facilitating-better-learning_1.jpg" style="padding-left: 5%;
  ...
  <section class="t-six-module grid-module">
    <div class="holder clearfix">
      <span class="layer-one parallax" data-speed="-0.02"></span>
      <div class="bgr-holder parallax" data-speed="0.0"
        style="background-image:url(/media/academics/senior_secondary/enhanced-learning_1.jpg);"></div>
      <article class="parallax" data-speed="0.0">
        <h3>Enhanced learning</h3>
        <h4>Applying concepts to real-life situations</h4>
        <p class="primary-para">The school curriculum is designed to train students in applying what they learn to real
          life situations. For example, Commerce students practice real-life learning by making visits to stock
          exchanges, meeting stock brokers, playing virtual games related to investments, etc. Our students get the
          opportunity to interact with experts from all walks of life so they get a better understanding of professional
          lives.
        </p>

      </article>
    </div>
    <img src="/media/academics/senior_secondary/enhanced-learning_1.jpg" style="padding-left: 5%;
    padding-right: 8%;" class="visible-xs">
  </section>
  <section class="default-theme fs-module hidden-xs ">
    <div class="media-holder bgr-holder " data-speed="-0.5"
      style="background-image: url(/media/academics/senior_secondary/secondary-school/holistic.jpg)"></div>
    <div class="media-holder bgr-holder media-holder-portrait"
      style="background-image: url(/media/academics/senior_secondary/senior-sec-bottom.jpg)"></div>
    <article class="" data-speed="-0.5"
      style="background: #ffffffd4; padding: 0.5% 4%; width: 87%;margin-bottom: -60px">
      <h3 style=" position: relative !important;
                      padding-bottom: 0px !important;
                      margin-bottom: 4px !important;
                      line-height: 36px !important;
                      font-weight: 400 !important;">Commitment to excellence</h3>
      <h2 class="last-para1">We strive to kindle every child’s intellectual capacity and mould them into confident
        individuals.</h2>
