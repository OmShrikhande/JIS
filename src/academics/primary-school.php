...
<head>
  ...
  <!--[if IE]>
      ...
      <![endif]-->
  <title>Academics | Primary School | The Jain International School</title>
  <link rel="icon" type="image/png" href="/media/academics/primary_school/favicon.png">
  <!-- Mobile Specific Metas ================================-->
  <meta http-equiv="X-UA-Compatible" content="IE=edge">
  <meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no">
  <meta name="author" content="Flying Penguins">
  <meta name="description"
    content="JIS Primary School, is where foundations are laid for learning and everything else that follows. Designed in a unique way to help smooth transition from kindergarten to formal schooling.">
  ...
  <!--<noscript>
 <img height="1" width="1" src="https://www.facebook.com/tr?id=2496256817260330&ev=PageView&noscript=1"/>
</noscript>-->
...
<body class="header-sticky">
  ...
  <!--end sticky panel-->
  <!--  <div id="banner-area" class="banner-area" style="background-image: url(/images/primary-school/primary-banner.jpg)" data-hover-only="true">
      </div> -->
  <section style="padding-bottom: 0px">
    <img src="/media/academics/primary_school/primary-banner-new.jpg" style="height: 480px; width: 1480px;" class="busban7">
  </section>
  <section class="upper-para-sec">
    <div class="container">
      <div class="row">
        <div class="col-md-10 col-md-offset-1">
          <p class="primary-para">Primary school is where foundations are laid for learning and everything else that
            follows. The transition from kindergarten to formal schooling is tough for most children, which is why; our
            curriculum is designed in a unique way to help smoothen this transition.</p>
          <br>

          <p class="primary-para">At The Jain International School, primary school is divided into two stages – Foundational
            School (standards I and II) and Junior School (Standards III, IV and V). The curriculum for primary school
            involves an amalgamation of several novel teaching methods to ensure that every child is prepared for
            secondary school. </p>
        </div>
      </div>
    </div>
  ...
  <section class="t-seven-module grid-module">
    <div class="holder clearfix">
      <article data-speed="-0.0">
        <h3>Foundational School</h3>
        <h4>A gentle introduction to formal schooling !!</h4>
        <p class="primary-para">Kindergarten to primary school is the first turning point in a child’s education
          journey. Standards I and II are treated differently, focusing on ‘school readiness’ of the child and preparing
          him or her for a more formal education. While Kindergarten’s play-oriented and curiosity-driven learning are
          kept intact, more methodical teaching tools are incorporated to aid learning. Our assessments are
          microskill-based to judge a child's cognitive ability holistically.</p>
      </article>
      <span class="layer-one parallax" data-speed="-0.02"></span>
      <div class="bgr-holder parallax" data-speed="0.0"
        style="background-image:url(/media/academics/primary_school/primary_foundation_schoolnew.jpg); width: auto">

      </div>
    </div>
    <img src="/media/academics/primary_school/primary2.jpg" style="padding-left: 5%;
  ...
  <section class="t-six-module grid-module">
    <div class="holder clearfix">
      <span class="layer-one parallax" data-speed="-0.02"></span>
      <div class="bgr-holder parallax" data-speed="0.0"
        style="background-image:url(/media/academics/primary_school/primary_junior_schoolnew.jpg);"></div>
      <article class="parallax" data-speed="0.0">
        <h3>Junior School</h3>
        <h4>Building the right foundation !</h4>
        <p class="primary-para">Junior school begins from standard III starting when children are introduced to various
          subjects more formally. Teaching involves a lot of activities, projects, story-telling, role-playing and
          ‘research based introductory activities'. Our students are proficient in English by the end of primary school
          owing to Kardi Path method of teaching that we employ for language development. They also have a strong
          foundation in Science, Social Science and Mathematics by the end of Standard V enabling a stressfree
    ...
    <br>
    <img src="/media/academics/primary-school/primary_junior_schoolnew.jpg" style="padding-left: 5%;
    padding-right: 8%;" class="visible-xs">
  </section>
  <section class="default-theme fs-module fs-modulenew1">
    <div class="media-holder bgr-holder bottomimg hidden-xs hidden-md" data-speed="-0.5"
      style="background-image: url(/media/academics/primary_school/primary-bottom-1-new.jpg"></div>
    <!-- <div class="media-holder bgr-holder media-holder-portrait" style="background-image: url(/images/primary-school/primary-bottom-1-new.jpg"></div> -->
    <article class="hidden-xs hidden-md" data-speed="-0.5"
      style="background: #ffffffd4; padding: 0.5% 4%;width: 87%;margin-bottom: -60px">
      <h3 style=" position: relative !important;
                      padding-bottom: 0px !important;
                      margin-bottom: 4px !important;
                      line-height: 36px !important;
                      font-weight: 400 !important;">Stepping stones</h3>
      <h2 class="last-para1">Pushing the boundaries of traditional education to improve learning experience</h2>
