        ...
        <div class="container">
          <div class="col-md-12">
            <ul class="nav nav-tabs">
              ...
              <li><a data-toggle="tab" href="#menu3">2nd Std</a></li>
              <li><a data-toggle="tab" href="#menu4">3rd Std</a></li>
              <li><a data-toggle="tab" href="#menu5">4th Std</a></li>
              <li><a data-toggle="tab" href="#menu6">5th Std</a></li>
              <li><a data-toggle="tab" href="#menu7">6th Std</a></li>
                  ...
                  <div class="row">
                    <div class="col-md-11" style="padding: 0px">
                      <table>
                        <thead>
                          <tr>
                            <th style="width: 15%;color: white" class="text-center">Sr. No.</th>
                            <th class="pad-left-6" style="width: 15%;color: white">Student Name</th>
                            <th class="pad-left-6" style="width: 15%;color: white">TC</th>
                          </tr>
                        </thead>
