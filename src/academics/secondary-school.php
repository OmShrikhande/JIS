...
<head>
  ...
  <!--[if IE]>
      ...
      <![endif]-->
  <title>Academics | Secondary School | The Jain International School</title>
  <link rel="icon" type="image/png" href="/media/academics/secondary_school/favicon.png">
  <!-- Mobile Specific Metas ================================-->
  <meta http-equiv="X-UA-Compatible" content="IE=edge">
  <meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no">
  <meta name="author" content="Flying Penguins">
  <meta name="description"
    content="JIS Secondary School, is where formal education, examinations and training for Board Exams begin.">
...
<body class="header-sticky">
  ...
  <div id="banner-area" class="banner-area"
    style="background-image: url(/media/academics/secondary_school/secondary_banner_final.jpg)" data-hover-only="true">
  </div>
  <!--<section class="upper-para-sec">
        <div class="container">
          <div class="row">
            <div class="col-md-10 col-md-offset-1">
              <p class="primary-para">Junior school begins from standard III starting when children are introduced to various subjects more formally. Teaching involves a lot of activities, projects, story-telling, role-playing and ‘research based introductory activities”. Our assessments are microskill-based to judge a child’s cognitive ability holistically. We follow continuous comprehensive evaluation of children throughout. Our students are proficient in English by the end of primary school owing to Kardi Path method of teaching that we employ in language development.
  ...
  <section class="t-seven-module grid-module">
    <div class="holder clearfix">
      <article data-speed="-0.0">
        ...
        <!-- <h4>Creative and balanced curriculum </h4> -->
        <p class="primary-para">An educational environment that inspires every child to achieve his best intellectually,
          socially, physically and creatively is what The Jain International School constantly strives for. Our Secondary
          School programme is formed by evolved curriculum planning to empower every child with self-confidence,
          decision-making skills and a zest for achieving success and knowledge.
        </p>
      </article>
      <span class="layer-one parallax" data-speed="-0.02"></span>
      <div class="bgr-holder parallax" data-speed="0.0"
        style="background-image:url(/media/academics/secondary_school/secondary-topright.jpg); width: auto">

      </div>
    </div>
    <img src="/images/secondary-school/formal-education.jpg" style="padding-left: 5%;
  ...
  <section class="t-six-module grid-module">
    <div class="holder clearfix">
      <span class="layer-one parallax" data-speed="-0.02"></span>
      <div class="bgr-holder parallax" data-speed="0.0"
        style="background-image:url(/media/academics/secondary_school/secondary-bottom-left.jpg);"></div>
      <article class="parallax" data-speed="0.0">
        <!--  <h3>Life Skills</h3>
           <h4>Values woven into every lesson</h4>  -->
        <p class="primary-para">Secondary School is where formal education, examinations and training for Board Exams
          begin. The teaching methods, however, remain progressive and modern to ensure that we inspire critical
          thinking and raise responsible citizens.
        </p>

      </article>
    </div>
    <img src="/media/academics/secondary_school/life-skills.jpg" style="padding-left: 5%;
    padding-right: 8%;" class="visible-xs">
  </section>
  <!--<section class="default-theme fs-module">
        <div class="media-holder bgr-holder " data-speed="-0.5" style="background-image: url(/images/secondary-school/holistic.jpg)"></div>
        <div class="media-holder bgr-holder media-holder-portrait" style="background-image: url(/images/secondary-school/holistic.jpg)"></div>
        <article class="" data-speed="-0.5" style="background: #ffffffd4; padding: 2%;">
          <h3>Holistic Education</h3>
          <h2 class="last-para">The process of education must develop a passion for learning, and this, is true success of a school.</h2>
