                    ...
                    <div class="col-md-12">
                        <article class="entry">
                            <div class="feature-post">
                               <center> <img src="/media/blogs/5. robot _ human.jpg" alt="image" style="width: 35%; height:35%"></center>
                            </div>
                            <div class="main-post">
                                <div class="row">
                                    <div class="col-md-10 col-md-offset-1">
                                        <h2 class="title-post"><a href="#">Robots Vs Humans</a></h2>
                                        <div class="meta-post clearfix">
                                            <ul>    
                                                <li class="post-author">
                                                    <span><a href="#">By Armaan Pashine</a></span>
                                                </li>                                        
