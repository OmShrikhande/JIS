...
<head>
  ...
  <!--[if IE]>
      ...
      <![endif]-->
  <title>Transport Facility | The Jain International School</title>
  <link rel="icon" type="image/png" href="/media/facilities/transport/favicon.png">
  <!-- Mobile Specific Metas ================================-->
  <meta http-equiv="X-UA-Compatible" content="IE=edge">
  <meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no">
  <meta name="author" content="Flying Penguins">
  <meta name="description"
    content="The Jain International school provides a well-organized, safe and flexible transportation facility to students and staff members.">
...
<body class="header-sticky">
  ...
  <!--end sticky panel-->
  <div id="banner-area" class="banner-area busban" style="background-image: url(/media/facilities/transport/tarnsport.jpg)"
    ...
    <div class="container">
      <div class="row">
        <div class="col-md-10 col-md-offset-1">
          <p class="primary-para">The school provides a well-organized and flexible transportation facility to students
            and staff members. The transportation is planned such that all sectors of the city are covered. Our buses
            weave an efficient network across the city.
          </p>
          <br>

          <p class="primary-para">

            The routes are clearly defined on main city roads and the focus is on the safety and security of our
            children. We ensure that students are brought to school and dropped back home under our vigilance safely.
            Parents are kept well-informed of the routes and timings.
  ...
  <section class="t-seven-module grid-module">
    <div class="holder clearfix">
      <article data-speed="-0.0">
        ...
        <h4>Well-planned and safe travel to school</h4>
        <p class="primary-para">
          All the JIS school buses bus are equipped with a first -aid box and a drinking water keg. The buses are also
          fitted with fire extinguishers. The school tracks the movement of the buses.
        </p>
      </article>
      <span class="layer-one parallax" data-speed="-0.02"></span>
      <div class="bgr-holder parallax" data-speed="0.0"
        style="background-image:url(/media/facilities/transport/bus1.png); width: auto">

      </div>
    </div>
    <img src="/media/facilities/transport/bus1.png" style="padding-left: 5%;
    padding-right: 8%;" class="visible-xs">
  </section>
  <section class="t-six-module grid-module">
    <div class="holder clearfix">
      <span class="layer-one parallax" data-speed="-0.02"></span>
      <div class="bgr-holder parallax" data-speed="0.0" style="background-image:url(/media/facilities/transport/bus2.png);">
      </div>
      <article class="parallax" data-speed="0.0">
        <h3>On the go</h3>
        <h4>Establishing a secure network</h4>
        <p class="primary-para">The school employs experienced and licensed bus drivers to operate their fleet of buses.
          The bus drivers, female conductors and staff deployed on the buses are competent and responsible. We include
          at least one female staff member on each bus .
        </p>

      </article>
    </div>
    <br>
    <img src="/media/facilities/transport/bus2.png" style="padding-left: 5%;
    padding-right: 8%;" class="visible-xs">
  </section>
  <section class="default-theme fs-module hidden-xs hidden-md">
    <div class="media-holder bgr-holder " data-speed="-0.5"
      style="background-image: url(/media/facilities/transport/transport-footer.jpg"></div>
    <div class="media-holder bgr-holder media-holder-portrait"
      style="background-image: url(/media/facilities/transport/transport-footer.jpg"></div>
    <article class="" data-speed="-0.5" style="background: #ffffffbd;padding: 2%">
      <h3>Transportation to school</h3>
      <h2 class="last-para">"The way to school is the one most memorable."</h2>
