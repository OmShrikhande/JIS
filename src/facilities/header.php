...
<div class="header_Name"
  ...
  <img style=" margin-left:2%;margin-right:10%;width: 5.5%; height:80%; margin-top: 1%;margin-bottom: 1%;border-radius: 50%;" src="https://drive.google.com/uc?export=view&id=16Z3-GcmzGV4DneS95xVvCSIypb0hMBNE"
      alt="trustee_logo">
        ...
        <nav class="mainnav" id="mainnav" style="padding-top:20px">
          <ul class="menu">
            ...
            <li><a href="#">Achievements</a>
              <ul class="submenu">
                <li><a href="/media-speaks/photos.php">Photos</a></li>
