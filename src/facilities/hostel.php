...
<head>
  ...
  <!--[if IE]>
      ...
      <![endif]-->
  <title>Facility | Hostel | The Jain International School</title>
  ...
  <meta name="description"
    content="The Jain International School offers excellent accommodation in the form of hostel focusses on providing homely care and personal attention to our students.">
...
<body class="header-sticky">
  ...
  <div class="header_Name"
    ...
    <div class="col-md-2 col-sm-12 col-xs-6 hide-on-mob-tab" style="width: 10.666667%;"><a href="/index" rel="home"><img
          alt="image" class="logo-height" src="/images/logo.png" style="margin-top: 6px;" /> </a></div>
    ...
    <div style="    margin-left: 50px;margin-top: 20px;"><a class="hide-on-mob-tab" href="/index" rel="home"><img
          alt="image" class="logo-height trustee_logo" src="/images/trustee_logo.png" /> </a></div>
  </div>
...
<!--<div class="tl-topbar bg-dark" id="tl-topbar">-->
  ...
  <!--end sticky panel-->
  <div id="banner-area" class="banner-area" style="background-image: url(/images/facilities/hostel4.jpg)"
    ...
    <div class="container">
      <div class="row">
        <div class="col-md-10 col-md-offset-1">
          <p class="primary-para">The Jain International School offers excellent accommodation in the form of hostel
            facility for boys of Std. 11 and 12 only ,that creates a disciplined system that is firm while conserving
            mutual respect. The hostel is comfortable allowing the students to focus on academics .</p>
          <br>

          <p class="primary-para">Our hostel focusses on providing homely care and personal attention to our students.
            Safety of students is our priority and we ensure that our JIS hostel is a safe haven for our students.
            Hostel life promotes camaraderie, independence and responsibility amongst the students. </p>
          <br>
          <p class="primary-para">Different accommodation facilities based on number of students sharing each room are
            available at The Jain International School hostel. Each child is provided with a cot, a study table & chair,
            and a cupboard. In addition there are dedicated study and recreation areas in the hostels. Laundry is taken
            care of regularly. Nourishing meals are served timely in the most hygienic conditions. Student health and
            welfare is of paramount importance at JIS.</p>
        </div>
      </div>
    </div>
  ...
  <!--    <section class="t-seven-module grid-module">
        <div class="holder clearfix">
          <article data-speed="-0.0">
            ...
            <h4>A pleasant stay within campus </h4>
            <p class="primary-para">Different accommodation facilities based on number of students sharing each room are available at the Jain International School hostel. Each child is provided with a cot, a study table & chair, and a cupboard. In addition there are dedicated study and recreation areas in the hostels. Laundry is taken care of regularly. Nourishing meals are served timely in the most hygienic conditions. Student health and welfare is of paramount importance at JIS. </p>
          </article>
          <span class="layer-one parallax" data-speed="-0.02"></span>
          <div class="bgr-holder parallax" data-speed="0.0" style="background-image:url(/images/facilities/hostel1.png); width: auto">

          </div>
        </div>

         <img src="/images/facilities/hostel1.png" style="padding-left: 5%;
    padding-right: 8%;" class="visible-xs">
      </section> -->
  <section class="t-six-module grid-module">
    <div class="holder clearfix">
      <span class="layer-one parallax" data-speed="-0.02"></span>
      <div class="bgr-holder parallax" data-speed="0.0" style="background-image:url(/images/facilities/hostel4.jpg);">
      </div>
      <article class="parallax" data-speed="0.0">
        <h3>Homely care</h3>
        <h4>A home away from home at JIS hostel</h4>
        <p class="primary-para">We ensure a huge emotional support to our students and make them feel at home in the
          hostel. We make every effort to empower our students with life skills that will stay with them forever and
          mould them into complete human beings. The hostel is replete with all facilities that the students may require
          in their daily routines so they don’t feel wanting for anything important. Ragging is severely punished and
          students are protected from emotional or physical misconduct. </p>

      </article>
    </div>
    <br>
    <img src="/images/facilities/hostel2.png" style="padding-left: 5%;
    padding-right: 8%;" class="visible-xs">
  </section>
  <!--       <section class="default-theme fs-module">
        <div class="media-holder bgr-holder " data-speed="-0.5" style="background-image: url(/images/facilities/hostel3.jpg);"></div>
        <div class="media-holder bgr-holder media-holder-portrait" style="background-image: url(/images/facilities/hostel3.jpg);"></div>
        <article class="" data-speed="-0.5" style="background: #ffffffd4; padding: 2%;">
          <h3>Staying in school</h3>
          <h2 class="last-para">“Boarding that raises strong, independent leaders ready to face the world.”</h2>
