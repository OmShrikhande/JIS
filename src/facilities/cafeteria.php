...
<head>
  ...
  <!--[if IE]>
      ...
      <![endif]-->
  <title>
    Facility | Cafeteria | The Jain International School</title>
  <link rel="icon" type="image/png" href="/media/facilities/cafeteria/favicon.png">
  <!-- Mobile Specific Metas ================================-->
  <meta http-equiv="X-UA-Compatible" content="IE=edge">
  <meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no">
  <meta name="author" content="Flying Penguins">
  <meta name="description"
    content="At JIS, the cafeteria offers a wide range of healthy snacks that also suit the tastes of young children. Quality of the food and hygiene are top priorities and uncompromised on.">
...
<body class="header-sticky">
  ...
  <!--end sticky panel-->
  <div id="banner-area" class="banner-area" style="background-image: url(/media/facilities/cafeteria/cafetria-banner.jpg)"
    ...
    <div class="container">
      <div class="row">
        <div class="col-md-10 col-md-offset-1">
          <p class="primary-para">The school has an organized system of dining throughout the year for the students. A
            well-balanced menu is designed in consultation with dieticians to ensure complete nourishment of the growing
            children.
          </p>
          <br>

          <p class="primary-para">The cafeteria offers a wide range of healthy snacks that also suit the tastes of young
            children. Unhealthy food is avoided at the cafeteria. At JIS, quality of the food and hygiene are top
            priorities and uncompromised on.

          </p>
        </div>
      </div>
    </div>
    <img src="/media/facilities/cafeteria/canteen4.jpg" style="padding-left: 5%;
  ...
  <section class="t-seven-module grid-module">
    <div class="holder clearfix">
      <article data-speed="-0.0">
        <h3>Varied choice </h3>
        <h4>Healthy food is one of our highest priorities</h4>
        <p class="primary-para">A comprehensive and well-balanced menu is set for the week and shared with the parents
          at the beginning of each week. The menu is also based on the age of the students and their nutrition demands.
          It includes a variety of children’s favourite snacks in addition to whole meals. </p>
      </article>
      <span class="layer-one parallax" data-speed="-0.02"></span>
      <div class="bgr-holder parallax" data-speed="0.0"
        style="background-image:url(/media/facilities/cafeteria/canteen4.jpg); width: auto">

      </div>
    </div>
    <br>
    <img src="/media/facilities/cafeteria/canteen1.jpg" style="padding-left: 5%;
    padding-right: 8%;" class="visible-xs">
  </section>
  <section class="t-six-module grid-module">
    <div class="holder clearfix">
      <span class="layer-one parallax" data-speed="-0.02"></span>
      <div class="bgr-holder parallax" data-speed="0.0" style="background-image:url(/media/facilities/cafeteria/canteen1.jpg);">
      </div>
      <article class="parallax" data-speed="0.0">
        <h3>Uncompromised quality</h3>
        <h4>Food quality that betters health</h4>
        <p class="primary-para">Food at the JIS cafeteria is prepared with highest quality, fresh ingredients by our
          professionally qualified chefs who are committed to cook and serve flavourful and healthy food to the
          students. A knowledgeable dietician is consulted for deciding the menu so that flavour and nourishment can be
          well-balanced while a manager oversees daily operations. The food served is free of preservatives, MSG or
  ...
  <section class="default-theme fs-module hidden-xs hidden-sm">
    <div class="media-holder bgr-holder " data-speed="-0.5"
      style="background-image: url(/media/facilities/cafeteria/canteen3.jpg);"></div>
    <div class="media-holder bgr-holder media-holder-portrait"
      style="background-image: url(/media/facilities/cafeteria/canteen3.jpg);"></div>
    <article class="" data-speed="-0.5" style="background: #ffffffd4; padding: 2%;">
      <h3>Dining in school</h3>
      <h2 class="last-para">“Our food should be our medicine and our medicine should be our food.”</h2>
