...
<head>
  ...
  <!--[if IE]>
      ...
      <![endif]-->
  <title>Facility | Library | The Jain International School</title>
  <link rel="icon" type="image/png" href="/media/facilities/library/favicon.png">
  <!-- Mobile Specific Metas ================================-->
  <meta http-equiv="X-UA-Compatible" content="IE=edge">
  <meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no">
  <meta name="author" content="Flying Penguins">
  <meta name="description"
    content="The library at The Jain International School, is a knowledge resource center where students access information through books as well as the internet.">
...
<body class="header-sticky">
  ...
  <!--end sticky panel-->
  <div id="banner-area" class="banner-area" style="background-image: url(/media/facilities/library/library.jpg)"
    ...
    <div class="container">
      <div class="row">
        <div class="col-md-10 col-md-offset-1">
          <p class="primary-para">A school library is that magical space where ideas brew, knowledge is shared and
            strong foundations are made. The library at JIS, is a knowledge resource center where students access
            information through books as well as the internet.
          </p>
          <br>

          <p class="primary-para">The library houses a vast collection of books ranging from textbooks, informative
            books to fictional books. Books are available as print as well as electronic. Our library is a temple of
            learning that develops imagination and life-long learning skills.
          </p>
        </div>
      </div>
    </div>
  ...
  <section class="t-seven-module grid-module">
    <div class="holder clearfix">
      <article data-speed="-0.0">
        ...
        <h4>Building blocks for a strong foundation</h4>
        <p class="primary-para">Our library is designed to provide information and knowledge that are vital to coping in
          today’s fast-paced world in addition to regular learning. We ensure that information is accessible easily and
          there are multiple sources to same information. We have built our collection carefully by including good
          quality books . We also stock our library with reference material in the form of periodicals, journals and
          smart-learning multimedia CDs.
        </p>
      </article>
      <span class="layer-one parallax" data-speed="-0.02"></span>
      <div class="bgr-holder parallax" data-speed="0.0"
        style="background-image:url(/media/facilities/library/lib5.jpg); width: auto">

      </div>
    </div>
    <img src="/media/facilities/library/lib5.jpg" style="padding-left: 5%;
    padding-right: 8%;" class="visible-xs">
  </section>
  <section class="t-six-module grid-module">
    <div class="holder clearfix">
      <span class="layer-one parallax" data-speed="-0.02"></span>
      <div class="bgr-holder parallax" data-speed="0.0" style="background-image:url(/media/facilities/library/library4.jpg);">
      </div>
      <article class="parallax" data-speed="0.0">
        <h3>An extra mile</h3>
        <h4>Access to invaluable information</h4>
        <p class="primary-para">The library is equipped with e-learning resources in addition to traditional books.
          Regular reading is encouraged in our curriculum. We push students to share ideas, get creative and evolve
          creatively. The library frequently conducts activities that inspire creativity and a yearning for better
          learning in young minds. The school library strives to equip students with skills that will help them
          throughout their lives and instill qualities of a responsible citizen into them.
        </p>

      </article>
    </div>
    <br>
    <img src="/media/facilities/library/library4.jpg" style="padding-left: 5%;
    padding-right: 8%;" class="visible-xs">
  </section>
  <section class="default-theme fs-module hidden-xs hidden-md">
    <div class="media-holder bgr-holder " data-speed="-0.5" style="background-image: url(/media/facilities/library/lib3.jpg);">
    </div>
    <div class="media-holder bgr-holder media-holder-portrait"
      style="background-image: url(/media/facilities/library/lib3.jpg);"></div>
    <article class="" data-speed="-0.5" style="background: #ffffffd4; padding: 2%;">
      <h3>Temple of learning</h3>
      <h2 class="last-para">At the moment that we persuade a child to cross that magic threshold into a library, we
        change their lives forever.</h2>
