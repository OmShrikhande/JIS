...
<head>
  <meta charset="utf-8">
  <title>About us | The Jain International School</title>
  <link rel="icon" type="image/png" href="/media/about_us/favicon.png">
  <meta http-equiv="X-UA-Compatible" content="IE=edge">
  <meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no">
  <meta name="author" content="Flying Penguins">
  <meta name="description"
    content="The Jain International School, a CBSE Day Boarding school, is a recognized name in quality education. It is the dream project of Sir Shantilal Badjate Charitable Trust, Nagpur.">
...
<body>
  ...
  <section>
    <video autoplay muted loop id="myVideo" width="640px" height="600px" style="width: 100%; margin-top: 8%;" controls>
      <source src="https://drive.google.com/uc?export=view&id=1Yz8EA6FYXcuU0BFsNCRgRz2sFXXXUUGw" type="video/mp4">
    </video>
  </section>
      ...
      <div class="row">
        <div class="col-lg-8">
          ...
          <div class="about-content">
            <p class="our-story-p">
              The Jain International School, a CBSE Day Boarding school, is a recognized name in quality education. It is
              the dream project of Sir Shantilal Badjate Charitable Trust, Nagpur. It is spread over a sprawling 43-acre
              campus on ‘Katol Road’, 12 km from central Nagpur amidst a lush green environment. The school commenced in
              Nagpur on 20th June, 2006 and since then has epitomized excellence in the field of education in Nagpur. It
              offers to school from Pre-Nursery-XII (Science & Commerce). It believes in integrating co-curricular
              activities with academics to help individuals in honing their skills and cultivating their talents. Jain
              International School prides itself in offering the most advanced state-of-the -art infrastructure,
              world-class academic and sports facilities and classrooms equipped with interactive e-boards which ensures
              IT integration in the teaching-learning process.
              <br><br>
              We believe that every child is special and our teaching techniques are designed in a way that gives equal
              value to academic achievements and development of life skills, hobbies and interests, values and culture.
              We also run feeder school, Little Jewels, which function at the pre-primary level in Khare Town, Nagpur.
              <br><br>
              <span style="color: #494753 !important;font-weight: 600;">To know more about Little Jewels visit
                –</span><br>

              Plot No.390, Main Road, Near Taori Marketing, Khare Town, Dharampeth, Nagpur - 440010 (Mb: 9607186961,
              9607186971) Email : littlejewels2010@gmail.com<br>
              Website : <a href="www.littlejewelsnagpur.in" style="color: #0c396e;">www.littlejewelsnagpur.in</a>
            </p>
            <!-- <a href="#" class="readmore-btn">Read More About Us</a> -->
          </div>
        </div>
        <div class="col-lg-4">
          <div class="about-box about-bg bg-overlay-green" style="background-image: url(https://dummyimage.com/370x245/cfcfcf/000000);
              margin-bottom: 10%;">
            <h3>Vision</h3>
            <!--<p>Our vision is to empower students to acquire valuable knowledge and skills, become confident individuals and contribute to the country and the world as responsible citizens.</p>-->
            <p>
              The school envisions
            <ul class="list-style-one">
              <li style="color: white;">Teachers who are knowledgeable, skilled and child-centered, guided by a
                content-rich curriculum. </li>
              <li style="color: white;">Incorporation of knowledge, analytical skills, communication capabilities and
                emotional intelligence in students.</li>
            </ul>
            </p>
          </div>

          <div class="about-box about-bg bg-overlay-red"
            style="background-image: url(https://dummyimage.com/370x245/cfcfcf/000000);height: 225px !important;">
            <h3>Mission</h3>
            <!--<p>Our mission is to help prepare students to grow confident and succeed in the fast-paced society. We strive to develop competent individuals with strengths of leadership and sound education.</p>-->
            <p>We, at The Jain International School, inspire all our students to develop a spirit of enquiry, empowering
              them with the skills, courage, optimism and integrity to pursue their dreams and enhance the lives of
              others.</p>
          </div>
  ...
  <section id="tl-video-area" class="tl-video-area video-bg bg-overlay" style="border-bottom: 5px solid
     #65b84f;">
    <div class="container">
      <div class="row">
        <div class="col-lg-12">
          ...
          <div class="video-area-wrapper">
            <!-- <a href="images/video.wbem"  class="video-icon video-play-btn" type="video/wbem">  -->
            <h3><a class="video-play-btn" href="lifeatjis.mp4">Take a School Tour</a></h3>
            <!--<a href="video/JIS_School_Tour/JIS_School_Tour.mp4" class="video-icon video-play-btn">-->
            <i class="fa fa-play"></i></a>

            <h5 class="video-title">Watch Our Short History</h5>
            <!--  <div class="video-btn-group">
                  <a href="/images/Prospectus1.pdf" target="_blank" class="btn btn-success btn-lg">Download Our prospectus</a>
                </div>  -->
  ...
  <!-- video section ends -->
  <!-- FunFact Area Start -->
  <!-- <section id="tl-funfact" class="tl-funfact dark-bg bg-overlay">
      <div class="container">
  ...
  <!--  <div class="row">
          <div class="col-md-4">
            <div class="single-counter-box">
              ...
              <i class="icon icon-users-couple color-yellow"></i>
              </span>
  ...
  <!-- Counter Content end -->
  <!-- </div> -->
  <!-- Single Counter Box end -->
  <!--  </div>
          <div class="col-md-4">
            <div class="single-counter-box">
              <span class="counter-icon">
              <i class="icon icon-face color-green"></i>
              </span>
              <div class="counter-content">
  ...
  <!--  </div>
          <div class="col-md-4">
            <div class="single-counter-box">
              <span class="counter-icon">
              <i class="icon icon-award color-orange"></i>
              </span>
              <div class="counter-content">
