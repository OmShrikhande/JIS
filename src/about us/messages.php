...
<head>
  <meta charset="utf-8">
  <title>Messages | The Jain International School</title>
  <link rel="icon" type="image/png" href="/media/about_us/messages/favicon.png">
...
<body>
  ...
  <!--===================End Header===========-->
  <div id="banner-area" class="banner-area" style="background-image: url(/media/about_us/messages/messages-banner.jpg)"
  ...
  <!-- Video Area End -->
  <!-- Team Start Start -->
  <section id="tl-team" class="tl-team pad-50">
    <div class="container">
      <div class="row">
        <div class="col-lg-12">
          <h2 class="column-title mb40">President's Message</h2>
          <!-- Column Title end -->
        </div>
      </div>
      <!-- Row End -->
      <div class="row">
        <div class="card pad-lf-rt">
          <div class="row ">
            <div class="col-md-4">
              <!--<iframe width="450" height="450" src="https://www.youtube.com/embed/SpU4DIVpLPc" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen class="video-border"></iframe>-->
              <img src="/media/about_us/messages/anuj.jpg" class="w-100" style="height: 350px">
            </div>
            <div class="col-md-8 px-3">
              <div class="card-block px-3 msg-pad-left-4">
                <!-- <h4 class="card-title">Lorem ipsum dolor sit amet</h4> -->
                <p class="card-text">With great pleasure, I write this message as the Director of The Jain International
                  School, Nagpur. At JIS, our teaching and non-teaching staff, students and parents come together in
                  harmony to form a community with a shared vision of bringing out the best in our children.

                  JIS has always believed to deliver the extraordinary and has stood true to its strength in its
                  qualitative journey in the last decade. Our children represent our dreams. We are committed towards
                  developing every child into a competent, independent human being well aware of his or her
                  responsibilities towards the society.


                  We teach our children to become leaders in this rather demanding world outside and raise them to cope
                  with challenges ahead.
                  The entire JIS family is a team complementing each other’s efforts in order to achieve our ambitions.
                  We make every effort to create a wholesome environment for every student to support overall growth,
                  inculcating moral and ethical values that are not plagued by any religious, class or racist dogmas.
                  With deep gratitude, I acknowledge the contribution of every member in the JIS fraternity who have
                  synchronized and harmonized at every step of our growth story.

                </p>
                <h5 class="director-name"> - Mr. Anuj Badjate</h5>
                <p class="card-text" style="line-height: 1.4;color: #494753;font-weight: 500;">President</p>
                <p style="line-height: 1.4;color: #494753;font-weight: 500;">The Jain International School, Nagpur.</p>
  ...
  <section id="tl-team" class="tl-team pad-50">
    <div class="container">
      <div class="row">
        <div class="col-lg-12">
          <h2 class="column-title mb40">Principal’s Message</h2>
          <!-- Column Title end -->
        </div>
      </div>
      <!-- Row End -->
      <div class="row">
        <div class="card pad-lf-rt">
          <div class="row ">
            <div class="col-md-4">
              <img src="/media/about_us/messages/principal.jpg" class="w-100" style="height: 510px">
            </div>
            <div class="col-md-8 px-3">
              <div class="card-block px-3 msg-pad-left-4">
                <!-- <h4 class="card-title">Lorem ipsum dolor sit amet</h4> -->
                <blockquote class="principal-bq"><i class="fa fa-quote-left" aria-hidden="true"></i> Education’s purpose
                  is to replace an empty mind with an open one.<i class="fa fa-quote-right"
                    aria-hidden="true"></i><br><span style="padding-left: 65%;line-height: 2.0;font-size: 18px;"> -
                    Malcolm Forbes</span></blockquote>
                <p class="card-text">At our school, we strive for excellence in shaping young individuals to become
                  well-groomed, upright and responsible citizens in future. We wish that by providing a complete
                  education to each child, he or she will blossom into a confident individual who is aware of his or her
                  capabilities and always strives to do the best. Our team of qualified and experienced teachers yearns
                  to identify the strengths and weaknesses of every child and help them grow better. They put extra
                  stress on building a foundation and nurturing values.
                  For an open mind, the mind has to have data and facts but after that the child has to be given the
                  space to think on his/her own, make mistakes, learn from them without being berated and formulate new
                  ideas and have their own interpretations and indulge in sensible discussions where ideas are shared,
                  refuted and applauded.
                  How many of us teachers and parents agree to this? Believe me, very few.
                  Today with all the information being available at the click of a button let us move away from mindless
                  replication of facts, let us celebrate different interpretations of the same topic, let us celebrate
                  debates and discussions and keep an OPEN mind! We will learn and live better!
                </p>
                <h5 class="director-name"> - Mrs. Anmol Badjatia </h5>
                 <p class="card-text" style="line-height: 1.4;color: #494753;font-weight: 500;">Principal</p>
                <p style="line-height: 1.4;color: #494753;font-weight: 500;">The Jain International School, Nagpur.</p>
                <!-- <p></p> -->
                <!-- <a href="#" class="btn btn-primary">Read More</a> -->
              </div>
  ...
  <section id="tl-team" class="tl-team pad-50">
    <div class="container">
      <div class="row">
        <div class="col-lg-12">
          <h2 class="column-title mb40">Vice-Principal’s Message</h2>
          <!-- Column Title end 
        </div>
      </div>
      <!-- Row End 
      <div class="row">
        <div class="card pad-lf-rt">
          <div class="row ">
            <div class="col-md-4">
              <img src="/images/vice-principal.jpg" class="w-100">
            </div>
            <!--
            <div class="col-md-8 px-3">
              <div class="card-block px-3 msg-pad-left-4">
                <!-- <h4 class="card-title">Lorem ipsum dolor sit amet</h4> 
                <blockquote class="principal-bq"><i class="fa fa-quote-left" aria-hidden="true"></i> The future belongs
                  to those who believe in their dreams.<i class="fa fa-quote-right" aria-hidden="true"></i><br><span
                    style="padding-left: 65%;line-height: 2.0;font-size: 18px;"> - Eleanor Roosevelt</span></blockquote>
                <p class="card-text">Young minds are like wet clay ; they can be moulded to perfection, given the right
                  direction and assurance. A child is always curious, open to exploration and experimentation and is
                  striving to understand the surroundings. If at this stage, the child is led into a world of learning,
                  by a group of loving, caring, understanding and well informed people, the child can successfully place
                  himself or herself at a high pedestal in society. Such children, as they grow, turn out to be
                  communicative, confident and self motivated adults, with great morality and inherent discipline. They
                  are prepared to face the challenges and demands of life, which are essential to be successful.
                  They can extend a positive and purposeful environment to all around them, thus fostering a healthy and
                  vibrant society. A perfect blend of values, ethics and learning, coupled with the right use of
                  technology, would further the dreams of the young child towards a bright future.. We at JIS, are
                  committed towards providing the perfect environment towards holistic development of our children i.e,
                  in the physical, mental, emotional, intellectual,
                  social and spiritual domains, such that they blossom into responsible and disciplined members of
                  society, while contributing meaningfully to it. We provide wings to the dreams of our children.
                </p>
                <h5 class="director-name"> - Mrs. Bhaswati Banerjee</h5>
                <!-- <p></p> -->
                <!-- <a href="#" class="btn btn-primary">Read More</a> 
              </div>
            </div>
