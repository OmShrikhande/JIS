...
<head>
  ...
  <!-- Site Title- -->
  <title>Management | Jain International School</title>

  <!-- Mobile Specific Metas ================================-->
  <meta http-equiv="X-UA-Compatible" content="IE=edge">
  <meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no">
  <meta name="author" content="Flying Penguins">
  <meta name="description" content="Jain International School, Nagpur | Management and Advisory Board Members.">
...
<body>
 ...
 <? include'Header/header.php' ?>
  ...
  <div>
    <video autoplay muted loop id="myVideo" width="640px" height="600px" style="width: 100%; margin-top: 8%;" controls>
      <source src="https://drive.google.com/uc?export=view&id=1Li0MCy5474Wznvt24Ulj99QufciPfnfC" type="video/mp4">
    </video>
  </div>

  <!-- About Us Start -->
  <section id="main-container" class="main-container pb30 pt60">
    <div class="container">
      <div class="row">
        <div class="col-lg-12">
          <h2 class="column-title text-center mb40">
            Management
          </h2>
        </div> <!-- Col end -->
      </div> <!-- Row End -->
        ...
        <div class="container">
          <div class="row row-spacing-bottom">
            <div class="row" style="padding-top: 5%;">
              ...
              <div class="col-lg-4">
                <img src="/media/about_us/management/shantilal-badjate-chairman.jpg" alt="" width="100%">
                <div class="image-footer-tea">
                  <h5 class="image-footer-padding-tea" style="width: 110%;"> Late. Shri Shantilal Badjate<br><span
                      class="stm-teacher__position">Founder</span></h5>
                </div>
              </div>
              <div class="col-lg-4 ">
              </div>
            ...
            <div class="row" style="padding-top: 5%;">
              <div class="col-lg-4 ">
                <img src="/media/about_us/management/anuj.jpg" alt="" width="70%">
                <div class="image-footer-tea">
                  <h5 class="image-footer-padding-tea">Mr. Anuj Badjate<br><span class="stm-teacher__position">President</span></h5>
                </div>
              </div>
              <div class="col-lg-4">
                <img src="/media/about_us/management/priti.png" alt="" width="70%">
                <div class="image-footer-tea">
                  <h5 class="image-footer-padding-tea"> Mrs. Priti Badjate<br><span class="stm-teacher__position">Trustee</span></h5>
                </div>
              </div>
              <div class="col-lg-4 ">
                <img src="/media/about_us/management/tushar-sir.jpg" alt="" width="70%">
                <div class="image-footer-tea">
                  <h5 class="image-footer-padding-tea">Mr. Tushar Badjate<br><span class="stm-teacher__position">Secretary</h5>
            ...
            <div class="row">
              ...
              <div class="col-lg-4" style="margin-left: 19%;">
                <img src="/media/about_us/management/sanjeev.png" alt="" width="70%">
                <div class="image-footer-tea">
                  <h5 class="image-footer-padding-tea">Mr. Sanjeev Agrawal<br><span class="stm-teacher__position">CEO</h5>
                </div>
              </div>
              <div class="col-lg-4">
                <img src="/media/about_us/management/principal.jpg" alt="" style="width: 70%; height: 300px;">
                <div class="image-footer-tea">
                  <h5 class="image-footer-padding-tea">Mrs. Anmol Badjatia<br><span class="stm-teacher__position">Principal</span></h5>
                </div>
              </div>
      ...
      <section class="pad-60" style="background-color: #f8f8f8;">
        <div class="container">
          <div class="row row-spacing-bottom">
            ...
            <div class="row" style="padding-top: 5%;">
              <div class="col-lg-4 ">
                <img src="/media/about_us/management/advisory_board/dr-shomie-das.jpg" alt="" width="70%">
                <div class="image-footer-tea">
                  <h5 class="image-footer-padding-tea">Dr. Shomie Das<br><span class="stm-teacher__position"> Chairman, Advisory Board</span></h5>
                </div>
              </div>
              <div class="col-lg-4">
                <img src="/media/about_us/management/advisory_board/fadnvis.jpg" alt="" width="70%">
                <div class="image-footer-tea">
                  <h5 class="image-footer-padding-tea" > Shri Devendraji Fadnavis<br><span class="stm-teacher__position"> Honorable Chief Minister of Maharashtra</span></h5>
                </div>
              </div>
              <div class="col-lg-4 ">
                <img src="/media/about_us/management/advisory_board/sunil-raisoni.jpg" alt="" width="70%">
                <div class="image-footer-tea">
                  <h5 class="image-footer-padding-tea">Mr. Sunil Raisoni<br><span class="stm-teacher__position">Chairman, Raisoni Group of Institutions</h5>
            ...
            <div class="row" style="padding-top: 5%;">
              <div class="col-lg-4 ">
                <img src="/media/about_us/management/advisory_board/sonal-jaiswal.jpg" alt="" width="70%">
                <div class="image-footer-tea">
                  <h5 class="image-footer-padding-tea" style="height: 30%;">Mrs. Sonal Jaiswal<br><span class="stm-teacher__position">Faculty for Management Training,  Nagpur</span></h5>
                </div>
              </div>
              <div class="col-lg-4">
                <img src="/media/about_us/management/advisory_board/sb-devpujari.jpg" alt="" width="70%">
                <div class="image-footer-tea">
                  <h5 class="image-footer-padding-tea"> Dr. S.B. Deopujari<br><span class="stm-teacher__position">M.D. D.C.H. MNAMS (Paed) Nagpur</span></h5>
                </div>
              </div>
              <div class="col-lg-4 ">
                <img src="/media/about_us/management/advisory_board/prashant-vaidya.jpg" alt="" width="70%">
                <div class="image-footer-tea">
                  <h5 class="image-footer-padding-tea">Mr. Prashant Vaidya<br><span class="stm-teacher__position">Managing Director, Purshuram Forge <br> Pvt. Ltd & Purshuram Tools</h5>
            ...
            <div class="row" style="padding-top: 5%;">
              <div class="col-lg-4 ">
                <img src="/media/about_us/management/advisory_board/shashikant-chaoudhary.jpg" alt="" width="70%">
                <div class="image-footer-tea">
                  <h5 class="image-footer-padding-tea">Mr. Shashikant Chaudhary<br><span class="stm-teacher__position"> M.D Global Logic Nagpur</span></h5>
                </div>
              </div>
              <div class="col-lg-4">
                <img src="/media/about_us/management/advisory_board/suresh-chari.jpg" alt="" width="70%">
                <div class="image-footer-tea">
                  <h5 class="image-footer-padding-tea"> Dr. Suresh Chari<br><span class="stm-teacher__position"></span> <p>Director Research </p> 
            </h5>
                </div>
              </div>
              <div class="col-lg-4 ">
                <img src="/media/about_us/management/advisory_board/rita-agrawal.jpg" alt="" width="70%">
                <div class="image-footer-tea">
                  <h5 class="image-footer-padding-tea">Ms Rita Aggarwal<br><span class="stm-teacher__position"> Consulting Psychologist, Nagpur</h5>
            ...
            <br>
            <br>
            <div class="row" style="padding-top: 5%; margin-left: 19%;">
              <div class="col-lg-4 ">
                <img src="/media/about_us/management/advisory_board/mukesh2.jpg" alt="" width="70%">
                <div class="image-footer-tea">
                  <h5 class="image-footer-padding-tea">Mr. Mukesh Agrawal<br><span class="stm-teacher__position">  Chartered Accountant,Nagpur</span></h5>
                </div>
              </div>
              <div class="col-lg-4" style="margin-left:10% ;">
                <img src="/media/about_us/management/advisory_board/supriya-verma.jpg" alt="" width="70%">
                <div class="image-footer-tea">
                  <h5 class="image-footer-padding-tea"> Mrs. Supriya Verma<br><span class="stm-teacher__position"></span> <p>  Director, Playhouse Kindergarten </p> 
            </h5>
                </div>
              </div>
            </div>
